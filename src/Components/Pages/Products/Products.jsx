...
const ProductSection = () => {
    ...
    return (
        <div className="p-8 bg-gradient-to-b from-gray-900 to-gray-800 text-white min-h-screen">
            ...
            >
                {products.map((product) => (
                    <motion.div
                        key={product._id}
                        className="bg-gray-800 p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-500"
            ...
            <div className="flex justify-center mt-12">
                <button
                    ...
                    disabled={page === 1}
                    className="px-6 py-3 bg-gray-700 hover:bg-gray-600 text-white rounded-lg mx-2 text-sm font-semibold"
                >
                    Previous
                </button>
                <button
